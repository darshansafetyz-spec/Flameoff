...
function buildBlogCard(blog, featured = false) {
  ...
  return `
    <article class="blog-card${featured ? ' blog-card--featured' : ''} reveal" role="article">
      <a href="blog-details.html?slug=${blog.slug}" class="blog-card__img-wrap" aria-label="Read ${blog.title}">
        ${hasImage
      ...
      <div class="blog-card__body">
        ...
        <a href="blog-details.html?slug=${blog.slug}" class="blog-card__read-more" aria-label="Read full article: ${blog.title}">
          Read Article
